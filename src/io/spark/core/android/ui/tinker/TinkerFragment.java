...
import io.spark.core.android.ImageGallery;
...
import io.spark.core.android.ui.corelist.SimpleVoiceService;
...
public class TinkerFragment extends BaseFragment implements OnClickListener {
	...
	static TextToSpeech 						ttobj;
	 static Locale 						localttsLanguage;
	...
	public static List<Pin> dPins = Py.list();
    ...
    Button 				Voicebtn, Facebtn, ReadSparkbtn, TrainFRbtn,GalleryFdbtn;
	static Pin selectedPin;


	public static Pin mpin, mpin2, mpin3;
	...
	private void setupListeners() {
		...
		Voicebtn = (Button)Ui.findView(this, R.id.Voicebtn);
	...
	//			 speakText("Pin "+ pin.name+ "is Off");
	//			 else
	//		    speakText("Pin " + pin.name + "is ON");
		//YSH
	...
	/*	public void TTSInitial(){
			ttobj=new TextToSpeech(getActivity(),
				      ...
				      public void onInit(int status) {
				         if(status != TextToSpeech.ERROR){
				        	 ...
				        	 localttsLanguage = ttobj.getLanguage();
		...
		public static void speakText(String toSpeak){
